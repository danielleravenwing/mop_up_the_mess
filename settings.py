...
TILE_SIZE = 32
TILES_WIDE = 25 # Mobile Phone size 11, small pc = 15
TILES_HIGH = 12 # Mobile Phone size 18, small pc = 20
...
# Sound effects
EFFECTS_SOUNDS = {'itempickup': 'itempickup.ogg', 'death': 'deathsplat.ogg', 'mop0': 'mop.ogg', 'mop1': 'mop2.ogg', 'multiply': 'drip.ogg', 'levelup': 'VictorySmall.ogg', 'invincible': 'invincible.ogg', 'explode': 'explode.ogg', 'shatter': 'shatter.ogg'}
